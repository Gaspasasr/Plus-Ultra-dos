...
economy = {
	...
	NUM_CLOSED_FACTORIES_PER_STATE_LASSIEZ_FAIRE = 8, -- Number of closed factories allowed per state under Lassiez Faire
...
diplomacy = {
	...
	AT_WAR_TENSION_DECAY = -1.0, -- for each potentially interested GP at war (value is if all possible GPs are at war) 
...
pops = {
	...
	LIFE_NEED_STARVATION_LIMIT = 0.85,
